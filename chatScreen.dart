                ...
                children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            'You',
                                            style: g.isDarkModeEnable ? Theme.of(context).primaryTextTheme.titleMedium : Theme.of(context).primaryTextTheme.bodyLarge,
                                          ),
                                        ),
                                        Text(
                  ...
                  Container(
                    ...
                    child: Chip(
                      ...
                      label: Text(
                        'Today',
                        style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.white70, fontSize: 12),
                      ),
                    ),
                  ),
                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            'Belle Benson',
                                            style: g.isDarkModeEnable ? Theme.of(context).primaryTextTheme.titleMedium : Theme.of(context).textTheme.bodyLarge,
                                          ),
                                        ),
                                        Text(
                                          'Hi, Good Morning',
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 5),
                                        child: Text('You', style: g.isDarkModeEnable ? Theme.of(context).primaryTextTheme.titleMedium : Theme.of(context).primaryTextTheme.bodyLarge),
                                      ),
                                      Text(

                              ...
                              children: [
                                CircleAvatar(
                                  ...
                                  child: Text(
                                    ...
                                    style: Theme.of(context).textTheme.displayLarge?.copyWith(fontSize: 22, color: Color(0xFF33196B), fontWeight: FontWeight.w500),
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontSize: 14, color: Colors.white),
                                  ),
                                )
                              ],
                            ),
    ...
    try {
      resultList = await MultiImagePicker.pickImages(
        ...
        materialOptions: MaterialOptions(
          ...
          actionBarColor: const Color(0xFF14012E),

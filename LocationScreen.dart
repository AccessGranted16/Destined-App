            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(AppLocalizations.of(context)!.lbl_location, style: Theme.of(context).primaryTextTheme.displayLarge),
                  Padding(
                  ...
                  Text(AppLocalizations.of(context)!.lbl_location_subtitle2, style: Theme.of(context).primaryTextTheme.titleSmall),
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: Color(0xFFEF3A6A), fontSize: 14, fontWeight: FontWeight.w600),
                      ),
                    ),
                  ),
                  Container(

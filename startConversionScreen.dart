            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(AppLocalizations.of(context)!.lbl_congrats, style: Theme.of(context).primaryTextTheme.displayLarge),
                  Padding(
                  ...
                  Text('Belle and You both Liked each other', style: Theme.of(context).primaryTextTheme.titleSmall),
                  InkWell(

...
import 'package:datingapp/screens/uploadIdScreen.dart';
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          'Cooking',
                                          style: Theme.of(context).textTheme.labelSmall?.copyWith(color: Colors.white60, fontSize: 13, fontWeight: FontWeight.normal, letterSpacing: 0),
                                        ),
                                      )
                                    ],
                                  ),
            ...
            child: ListTile(
              ...
              trailing: InkWell(
                ...
                child: Text(
                  ...
                  style: Theme.of(context).textTheme.titleLarge?.copyWith(fontSize: 14, color: Color(0xFFDD3663)),
                ),
              ),
            ),
          ),
